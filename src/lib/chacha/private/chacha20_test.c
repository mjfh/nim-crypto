...
#ifdef NIMSRC_LOCAL                                              /* patched */
static char big_buf[10 * 1024];                                  /* patched */
#define puts(s)     { strcat(big_buf,s); strcat(big_buf,"\n"); } /* patched */
#define printf(f,n) { sprintf(big_buf+strlen(big_buf),f,n); }    /* patched */
#endif /* NIMSRC_LOCAL */                                        /* patched */
...
char *chacha20_test() // int main()            /* patched */
{
